...
!define MUI_ICON "..\icons\simsu.ico"
!define MUI_UNICON "..\icons\simsu.ico"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\Simsu.exe"
...
Section "install"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\Simsu.exe$\""
	...
	CreateShortCut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\Simsu.exe"
